...
class HuangHsiangFetcher(CompanyFetcher):
    """皇翔建設 爬蟲"""

    company_id = "huang_hsiang"
    company_name = "皇翔建設"
    news_url = "https://www.皇翔建設.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 皇翔建設")
        return documents
