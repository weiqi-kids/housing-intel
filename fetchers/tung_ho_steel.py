...
class TungHoSteelFetcher(CompanyFetcher):
    """東和鋼鐵 爬蟲"""

    company_id = "tung_ho_steel"
    company_name = "東和鋼鐵"
    news_url = "https://www.東和鋼鐵.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 東和鋼鐵")
        return documents
