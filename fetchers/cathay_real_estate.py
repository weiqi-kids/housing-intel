...
class CathayRealEstateFetcher(CompanyFetcher):
    """國泰建設 爬蟲"""

    company_id = "cathay_real_estate"
    company_name = "國泰建設"
    news_url = "https://www.國泰建設.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 國泰建設")
        return documents
...
if __name__ == "__main__":
    fetcher = CathayRealEstateFetcher()
