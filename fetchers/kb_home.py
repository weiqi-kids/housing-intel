...
class KbHomeFetcher(CompanyFetcher):
    """KB Home 爬蟲"""

    company_id = "kb_home"
    company_name = "KB Home"
    news_url = "https://www.kbhome.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from KB Home")
        return documents
