...
class TollBrothersFetcher(CompanyFetcher):
    """Toll Brothers 爬蟲"""

    company_id = "toll_brothers"
    company_name = "Toll Brothers"
    news_url = "https://www.tollbrothers.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.tollbrothers.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Toll Brothers")
        return documents
