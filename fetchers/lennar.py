...
class LennarFetcher(CompanyFetcher):
    """Lennar 爬蟲"""

    company_id = "lennar"
    company_name = "Lennar"
    news_url = "https://www.lennar.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Lennar")
        return documents
