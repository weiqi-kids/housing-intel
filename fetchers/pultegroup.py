...
class PultegroupFetcher(CompanyFetcher):
    """PulteGroup 爬蟲"""

    company_id = "pultegroup"
    company_name = "PulteGroup"
    news_url = "https://www.pultegroup.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.pultegroup.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from PulteGroup")
        return documents
