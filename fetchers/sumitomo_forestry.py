...
class SumitomoForestryFetcher(CompanyFetcher):
    """住友林業 爬蟲"""

    company_id = "sumitomo_forestry"
    company_name = "住友林業"
    news_url = "https://www.住友林業.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 住友林業")
        return documents
...
if __name__ == "__main__":
    fetcher = SumitomoForestryFetcher()
