...
class HuakuFetcher(CompanyFetcher):
    """華固建設 爬蟲"""

    company_id = "huaku"
    company_name = "華固建設"
    news_url = "https://www.華固建設.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 華固建設")
        return documents
