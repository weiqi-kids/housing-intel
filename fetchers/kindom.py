...
class KindomFetcher(CompanyFetcher):
    """冠德建設 爬蟲"""

    company_id = "kindom"
    company_name = "冠德建設"
    news_url = "https://www.冠德建設.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 冠德建設")
        return documents
