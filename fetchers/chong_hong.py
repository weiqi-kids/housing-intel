...
class ChongHongFetcher(CompanyFetcher):
    """長虹建設 爬蟲"""

    company_id = "chong_hong"
    company_name = "長虹建設"
    news_url = "https://www.長虹建設.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 長虹建設")
        return documents
