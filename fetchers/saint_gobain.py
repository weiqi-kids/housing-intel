...
class SaintGobainFetcher(CompanyFetcher):
    """Saint-Gobain 爬蟲"""

    company_id = "saint_gobain"
    company_name = "Saint-Gobain"
    news_url = "https://www.saint-gobain.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.saint-gobain.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Saint-Gobain")
        return documents
