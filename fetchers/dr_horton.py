...
class DrHortonFetcher(CompanyFetcher):
    """D.R. Horton 爬蟲"""

    company_id = "dr_horton"
    company_name = "D.R. Horton"
    news_url = "https://www.drhorton.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from D.R. Horton")
        return documents
