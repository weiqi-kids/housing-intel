...
class FargloryFetcher(CompanyFetcher):
    """遠雄建設 爬蟲"""

    company_id = "farglory"
    company_name = "遠雄建設"
    news_url = "https://www.遠雄建設.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 遠雄建設")
        return documents
