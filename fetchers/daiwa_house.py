...
class DaiwaHouseFetcher(CompanyFetcher):
    """大和房屋 爬蟲"""

    company_id = "daiwa_house"
    company_name = "大和房屋"
    news_url = "https://www.大和房屋.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 大和房屋")
        return documents
