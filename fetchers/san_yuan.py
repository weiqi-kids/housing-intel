...
class SanYuanFetcher(CompanyFetcher):
    """三圓建設 爬蟲"""

    company_id = "san_yuan"
    company_name = "三圓建設"
    news_url = "https://www.三圓建設.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 三圓建設")
        return documents
