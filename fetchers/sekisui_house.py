...
class SekisuiHouseFetcher(CompanyFetcher):
    """積水房屋 爬蟲"""

    company_id = "sekisui_house"
    company_name = "積水房屋"
    news_url = "https://www.積水房屋.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 積水房屋")
        return documents
