...
class RuentexFetcher(CompanyFetcher):
    """潤泰新 爬蟲"""

    company_id = "ruentex"
    company_name = "潤泰新"
    news_url = "https://www.潤泰新.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 潤泰新")
        return documents
