...
class HighwealthFetcher(CompanyFetcher):
    """興富發建設 爬蟲"""

    company_id = "highwealth"
    company_name = "興富發建設"
    news_url = "https://www.興富發建設.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 興富發建設")
        return documents
