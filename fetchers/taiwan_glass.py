...
class TaiwanGlassFetcher(CompanyFetcher):
    """台灣玻璃 爬蟲"""

    company_id = "taiwan_glass"
    company_name = "台灣玻璃"
    news_url = "https://www.台灣玻璃.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 台灣玻璃")
        return documents
