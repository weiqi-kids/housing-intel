...
class NipponSteelFetcher(CompanyFetcher):
    """日本製鐵 爬蟲"""

    company_id = "nippon_steel"
    company_name = "日本製鐵"
    news_url = "https://www.日本製鐵.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 日本製鐵")
        return documents
